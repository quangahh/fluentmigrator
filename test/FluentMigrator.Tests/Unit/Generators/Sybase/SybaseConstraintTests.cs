...
{
    public class SybaseConstraintTests : BaseConstraintsTests
    {
        ...
        public void CanAlterDefaultConstraintWithCurrentUserAsDefault()
        {
            ...
            var expected = "ALTER TABLE [dbo].[TestTable1] REPLACE [TestColumn1] DEFAULT USER";
        ...
        public void CanAlterDefaultConstraintWithCurrentDateAsDefault()
        {
            ...
            var expected = "ALTER TABLE [dbo].[TestTable1] REPLACE [TestColumn1] DEFAULT GETDATE()";
        ...
        public void CanAlterDefaultConstraintWithCurrentUtcDateAsDefault()
        {
            ...
            var expected = "ALTER TABLE [dbo].[TestTable1] REPLACE [TestColumn1] DEFAULT GETUTCDATE()";
        ...
        public void CanAlterDefaultConstraintWithNewGuidAsDefault()
        {
            ...
            var expected = "ALTER TABLE [dbo].[TestTable1] REPLACE [TestColumn1] DEFAULT NEWID()";
        ...
        public void CanAlterDefaultConstraintWithStringAsDefault()
        {
            ...
            var expected = "ALTER TABLE [dbo].[TestTable1] REPLACE [TestColumn1] DEFAULT N'TestString'";
